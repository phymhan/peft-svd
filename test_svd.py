...
from utils import register_spectral_shift, get_svd_delta_state_dict, load_svd_ckpt
...
state_dict, running = get_svd_delta_state_dict(pretrained_resnet)
state_dict = {'state_dict': state_dict, 'running': running}
torch.save(state_dict, 'resnet18_cifar10_delta.pth')
...
loaded_resnet = load_svd_ckpt(
    loaded_resnet,
    'resnet18_cifar10_delta.pth',
